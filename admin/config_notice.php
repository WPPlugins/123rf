...
if (!isset($_GET['page']) || (isset($_GET['page']) && $_GET['page'] != 'Plugin123RF'))
{
?>
<div class="updated microstockphotoplugin_config_notice" style="padding: 10px;">
  <div style="float: left; padding-top: 5px;"><?php echo __('Please configure the 123RF Plugin on', self::ld).' <a href="'.admin_url('options-general.php?page=Plugin123RF&dismiss=1').'">'.__('the options page', self::ld).'</a>.'; ?></div>
  ...
  jQuery(document).ready(function($)
  {
    ...
    {
      $.post('<?php echo admin_url('admin-ajax.php?action=Plugin123RF'); ?>', {'a': 'dismiss_config_notice'}, function(r)
      {
