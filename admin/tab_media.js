  ...
  return wp.media.view.MediaFrame.Post = MediaFrame.extend({
    initialize: function() {
      ...
      this.on('open', function() {
        var id;
        id = 'mpp-Plugin123RF_depositphotos';
      ...
      for (_j = 0, _len1 = _ref1.length; _j < _len1; _j++) {
        ...
        this.states.add([
          new wp.media.controller.MPP({
            ...
            title: '<img src="' + module.icon + '" width="16" height="16" style="margin-right: 3px; position: relative; top: 2px;" /> ' + module.title + (module["new"] ? '<span style="font-size: 8px;color: #ff0000;top: -5px;position: relative;font-weight: bold;margin-left: 4px;">' + Plugin123RF.text["new"] + '</span>' : ''),
            headerTitle: '<img src="' + module.icon + '" width="16" height="16" style="margin-right: 5px;" /> ' + module.title + (module["new"] ? '<span style="font-size: 11px;color: #ff0000;top: -7px;position: relative;font-weight: bold;margin-left: 4px;">' + Plugin123RF.text["new"] + '</span>' : ''),
            priority: 200,
            type: 'link'
          })
        ]);
